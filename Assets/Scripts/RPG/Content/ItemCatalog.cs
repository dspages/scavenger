public static class ItemCatalog
{
    ...
    public static readonly WeaponData Cutlass = new WeaponData
    {
        ...
        handedness = EquippableHandheld.Handedness.OneHanded,
        tag = EquippableHandheld.HandheldTag.Metallic,
    ...
    public static readonly WeaponData ReachPike = new WeaponData
    {
        ...
        handedness = EquippableHandheld.Handedness.TwoHanded,
        tag = EquippableHandheld.HandheldTag.Polearm,
        rangeType = EquippableHandheld.RangeType.Melee,
        damageType = DamageType.Piercing,
        damage = 10,
        minRange = 2,
    ...
    public static readonly WeaponData SteelShield = new WeaponData
    {
        ...
        handedness = EquippableHandheld.Handedness.Shield,
        tag = EquippableHandheld.HandheldTag.Metallic,
        rangeType = EquippableHandheld.RangeType.Melee,
    ...
    public static readonly WeaponData LongMusket = new WeaponData
    {
        ...
        handedness = EquippableHandheld.Handedness.TwoHanded,
        tag = EquippableHandheld.HandheldTag.Firearm,
